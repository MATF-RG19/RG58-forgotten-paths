...
$(PROGRAM): main.o mazeGenerator.o draw.o image.o
	$(CC) $(CFLAGS) -o $(PROGRAM) main.o mazeGenerator.o draw.o light.o image.o $(LIBS)

main.o:  main.c mazeGenerator.o draw.o light.o
	gcc -c $(CFLAGS) -o main.o main.c mazeGenerator.o draw.o light.o $(LIBS)
...
light_textures.o: light.c
	gcc -c $(CFLAGS) -o light_textures.o light.c $(LIBS)
